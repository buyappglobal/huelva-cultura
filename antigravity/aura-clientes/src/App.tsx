      ...
      <div className="min-h-screen bg-black text-white flex items-center justify-center p-4">
        ...
        <div className="w-full max-w-md bg-[#0d0d0d] border border-white/10 rounded-2xl p-8 shadow-2xl relative z-10 backdrop-blur-md">
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-xs text-white/40 mt-1">{authMode === 'login' ? 'Acceso a Ficha de Cliente' : 'Activa tus 21 Días Gratis'}</p>
          </div>
          ...
          <div className="mt-8 text-center flex flex-col items-center gap-3">
            ...
            >
              {authMode === 'login' ? "Prueba Gratis 21 Días" : "Iniciar Sesión"}
            </button>
          </div>
