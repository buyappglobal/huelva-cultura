        ...
        >
          <div className="mb-10 flex flex-col items-center text-center">
            ...
            <p className="mt-2 text-xs text-white/40">
              {step === 'email' 
                ? 'Acceso exclusivo administrativo mediante código PIN.' 
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            {step === 'email' ? (
              <div className="space-y-2 text-left">
                <label className="text-[10px] font-bold uppercase tracking-widest text-white/40 block">Email del Administrador</label>
